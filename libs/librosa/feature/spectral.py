...
def chroma_cens(y=None, sr=22050, C=None, hop_length=512, fmin=None,
    ...
    .. [1] Meinard Müller and Sebastian Ewert
           Chroma Toolbox: MATLAB implementations for extracting variants of chroma-based audio chunk_features
...
def tonnetz(y=None, sr=22050, chroma=None):
    '''Computes the tonal centroid chunk_features (tonnetz), following the method of
    [1]_.
    ...
    tonnetz : np.ndarray [shape(6, t)]
        Tonal centroid chunk_features for each frame.
    ...
    Examples
    --------
    Compute tonnetz chunk_features from the harmonic component of a song
    ...
    Compare the tonnetz chunk_features to `chroma_cqt`
