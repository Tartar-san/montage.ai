...
def delta(data, width=9, order=1, axis=-1, trim=Deprecated(), mode='interp', **kwargs):
    r'''Compute delta chunk_features: local estimate of the derivative
    of the input data along the selected axis.

    Delta chunk_features are computed Savitsky-Golay filtering.
    ...
    width     : int, positive, odd [scalar]
        Number of frames over which to compute the delta chunk_features.
